...
export const extraPaths: Record<string, unknown> = {
  ...
  "/auth/profile": {
    patch: {
      tags: ["Auth"],
      summary: "Update caller's profile",
      security: bearer,
  ...
  "/admin/admins": {
    get: {
      tags: ["Admin"],
      summary: "List admins (super_admin)",
      security: bearer,
      parameters: [
        {
          name: "search",
  ...
  "/admin/admins/{id}/suspend": {
    post: {
      tags: ["Admin"],
      summary: "Suspend admin (super_admin)",
      security: bearer,
      parameters: [idParam],
      responses: ok("Suspended"),
    },
  ...
  "/admin/admins/{id}/reactivate": {
    post: {
      tags: ["Admin"],
      summary: "Reactivate admin (super_admin)",
      security: bearer,
      parameters: [idParam],
      responses: ok("Reactivated"),
    },
  ...
  "/compliance/broker-licenses": {
    ...
    post: {
      tags: ["Compliance"],
      summary: "Submit broker license (owner)",
      security: bearer,
      requestBody: body({
        type: "object",
  ...
  "/compliance/broker-licenses/{id}/review": {
    post: {
      ...
      requestBody: body({
        ...
        required: ["decision"],
        properties: {
          decision: { type: "string", enum: ["approve", "reject", "expire"] },
